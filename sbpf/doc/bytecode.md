...
| `2C` / `00101100`  | only in v2  | `ldxb dst, [src + off]`
...
| `C6` / `11000110`  | only in v2  | `sdiv32 dst, imm`  | `dst = ((dst as i32) / (imm as i32)) as u32 as u64`
...
| `85` / `10000101`  | all         | `call imm` or `syscall imm`
